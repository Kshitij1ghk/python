...
# here sep=None and end=None means that the default values of sep and end will be used
# sep=None means that the default value of sep will be used which is space
# end=None means that the default value of end will be used which is \n
